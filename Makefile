...
pkglibexecdir = $(libexecdir)/libupnp
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(srcdir)/autoconfig.h.in \
	$(top_srcdir)/upnp/inc/upnpconfig.h.in $(srcdir)/libupnp.pc.in \
...
CONFIG_HEADER = autoconfig.h $(top_builddir)/upnp/inc/upnpconfig.h
CONFIG_CLEAN_FILES = libupnp.pc
...
ACLOCAL = ${SHELL} /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20/build-aux/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20/build-aux/missing automake-1.13
AWK = gawk
CC = gcc
...
LT_VERSION_UPNP = 9:4:3
MAKEINFO = ${SHELL} /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 1.6.20
abs_builddir = /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20
abs_srcdir = /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20
abs_top_builddir = /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20
abs_top_srcdir = /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
...
docdir = ${datarootdir}/doc/libupnp-1.6.20
dvidir = ${docdir}
exec_prefix = ${prefix}
...
install_sh = ${SHELL} /home/heenbo/work/test/test_upnp_lib-2/libupnp-1.6.20/build-aux/install-sh
...
upnp/inc/upnpconfig.h: upnp/inc/stamp-h2
	@if test ! -f $@; then rm -f upnp/inc/stamp-h2; else :; fi
	@if test ! -f $@; then $(MAKE) $(AM_MAKEFLAGS) upnp/inc/stamp-h2; else :; fi

upnp/inc/stamp-h2: $(top_srcdir)/upnp/inc/upnpconfig.h.in $(top_builddir)/config.status
	@rm -f upnp/inc/stamp-h2
	cd $(top_builddir) && $(SHELL) ./config.status upnp/inc/upnpconfig.h

distclean-hdr:
	-rm -f autoconfig.h stamp-h1 upnp/inc/upnpconfig.h upnp/inc/stamp-h2
libupnp.pc: $(top_builddir)/config.status $(srcdir)/libupnp.pc.in
...
all-am: Makefile $(DATA) autoconfig.h
